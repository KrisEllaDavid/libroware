    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center py-10">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">Loading books...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-md">
          <p className="text-red-700 dark:text-red-300">Error loading books: {error.message}</p>
        </div>
      </div>
    );
  }
      ...
      {books.length === 0 ? (
        <div className="text-center py-10 bg-white dark:bg-gray-800 rounded-lg shadow">
          <p className="text-gray-500 dark:text-gray-400">
            {searchTerm ? "No books match your search." : "No books in the library catalog."}
          </p>
        </div>
      ) : (
              ...
              <div className="p-4 flex-grow">
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">{book.pageCount}</span>
                  </div>
